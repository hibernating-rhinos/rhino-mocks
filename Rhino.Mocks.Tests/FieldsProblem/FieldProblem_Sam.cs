...
namespace Rhino.Mocks.Tests.FieldsProblem
{
	...
	public class FieldProblem_Sam
	{
		...
		public void WillRememberExceptionInsideOrderRecorderEvenIfInsideCatchBlock()
		{
			...
			var ex = Assert.Throws<ExpectationViolationException>(() => mockRepository.VerifyAll());
			Assert.Equal("Unordered method call! The expected call is: 'Ordered: { IInterfaceWithThreeMethods.C(); }' but was: 'IInterfaceWithThreeMethods.B();'", ex.Message);
		}
	}
